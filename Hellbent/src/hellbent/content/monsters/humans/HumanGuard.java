...
public class HumanGuard extends GenericMonster {
	
	public HumanGuard(HellbentGame h) throws SlickException
	{
		super(h);
		this.setAwake(true);
		this.setName("giant rat");
		this.setType("HUMAN_GUARD");
...
*/
	public HumanGuard clone()
	{
		try {
			return new HumanGuard(hg);
